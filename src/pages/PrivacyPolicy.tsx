            ...
            <div className="container py-3">
                ...
                <main>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to Tent Admin, accessible from{" "}
                                <a href="https://tentadmin.com" rel="external nofollow noopener noreferrer" target="_blank">
                                    https://tentadmin.com
                                </a>
                            </p>
                        </li>
                    ...
                    <p>
                        ...
                        mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser
                    ...
                    <ul>
                        <li>
                            <strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to
                            contact You.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are
                    ...
                    <p>
                        ...
                        allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have
                        provided to Us.
                    </p>
                    ...
                    <p>
                        Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If
                        You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have
                    ...
                    <ul>
                        <li>By email: info@tentadmin.com</li>
                    </ul>
                </main>
                <Footer />
            </div>
