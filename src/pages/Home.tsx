      ...
      <main>
        ...
        <div className="container ">
          <div className="row">
            ...
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-dashboard-products.jpg"
          ...
          <div className="row my-5">
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-admin-dashboard.jpg"
                className="rounded img-fluid shadow"
                alt="Tent Admin Dashboard"
              />
            </div>
          ...
          <div className="row my-5">
            ...
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-admin-form.jpg"
          ...
          <div className="row my-5">
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-admin-card.jpg"
          ...
          <div className="row my-5">
            ...
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-admin-popover.jpg"
                className="rounded img-fluid w-50"
                alt="Tent Admin Dashboard"
              />
            </div>
          ...
          <div className="row my-5">
            <div className="col-6 p-3 d-flex flex-column justify-content-center align-items-center">
              <img
                src="/assets/images/tent-admin-context-menu.jpg"
